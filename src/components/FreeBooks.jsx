...
export default function FreeBooks() {
  ...
  return (
    <main className="my-3 lg:my-5 bg-[#1f9065] rounded-md p-4 mt-3 cursor-pointer lg:h-[30%] lg:p-2 lg:w-[20%] lg:mt-16">
      <header>
        <h1 className="font-bold text-lg text-white p-2 cursor-pointer hover:text-gray-200">{t("library")}</h1>
      </header>
      <section className="text-white flex flex-col gap-2 my-3">
        {freeBooks.length > 0 && (
          <>
            ...
            />
            <p className="font-semibold text-xl cursor-pointer hover:text-gray-200">{freeBooks[current].title}</p>
